<template>
  <div class="box" v-loading="loading" element-loading-text="拼命加载中">
    ...
    >
      ...
      <el-table-column label="BannerURL" width="200">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    UploadUrl () {
      return this.$store.state.BaseUrl + '/upload/imgupload'
    },
    // 控制编辑
    ...
    update () {
      ...
      this.$axios
        .post(this.$store.state.BaseUrl + '/banner/editbanner', {
          bannerid, // BannerID
          bannerurl, // BannerURL
          yxj, // 优先级
          linkurl, // 链接URL
    ...
    handleDelete (index, row, bannerid) {
      let _this = this
      this.$axios
        .post(this.$store.state.BaseUrl + '/banner/delbanner', {bannerid})
        .then(res => {
    ...
    updatebanner () {
      ...
      console.log(bannerurl)
      this.$axios
        .post(this.$store.state.BaseUrl + '/banner/addbanner', {
          bannerid, // BannerID
          bannerurl, // BannerURL
          yxj, // 优先级
          linkurl, // 链接URL
